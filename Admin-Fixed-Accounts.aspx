<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Admin-Fixed-Accounts.aspx.cs" Inherits="Banking_WEB.Admin_Fixed_Accounts" %>
        ...
        <div class="row">
                ...
                <div class="card shadow-lg border-0">
                    <div class="card-body px-4 py-5">
                        ...
                        <div class="card-header bg-white border-0 pt-3 text-center">
                            <h3 class="fw-bold" style="color: #2b4d6e;">Fixed Account</h3>
                            <p class="text-muted small">Manage and review fixed account details</p>
                        </div>
                        ...
                        <div class="mb-3">
                            <label for="fixedAccountID" class="form-label">Fixed Account ID</label>
                            <asp:TextBox ID="txtFixedAccountID" runat="server" CssClass="form-control" ReadOnly="True"></asp:TextBox>
                        </div>
                        <div class="mb-3">
            ...
            <div class="col-md-7 mb-4">
                <div class="card shadow-lg border-0 h-100">
                    <div class="card-body">
                        <h4 class="fw-bold text-primary text-center mb-0">Fixed Account History</h4>
                        <hr>
                        <div class="card-body px-4 py-3">
                            <div style="overflow-x: auto;">
                                <asp:GridView runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered" DataSourceID="SqlDataSource1">
                                    <Columns>
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Banking_AppConnectionString %>" SelectCommand="SELECT * FROM [Fixed_Account]"></asp:SqlDataSource>
                            </div>
                        </div>
                    </div>
                </div>
