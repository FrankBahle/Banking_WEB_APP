<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Fixed_Transaction_Management.aspx.cs" Inherits="Banking_WEB.Fixed_Transaction_Management" %>
        ...
        <div class="row">
                ...
                <div class="card shadow-lg border-0">
                    <div class="card-body px-4 py-5">
                        ...
                        <div class="card-header bg-white border-0 pt-3 text-center">
                            <h3 class="fw-bold" style="color: #2b4d6e;">Transaction Fixed</h3>
                            <p class="text-muted small">Manage and review fixed transaction details</p>
                        </div>
                        ...
                        <div class="mb-3">
                            <label for="transactionFixedID" class="form-label">Transaction Fixed ID</label>
                            <asp:TextBox ID="txtTransactionFixedID" runat="server" CssClass="form-control" ReadOnly="True"></asp:TextBox>
                        </div>
            ...
            <div class="col-md-7 mb-4">
                <div class="card shadow-lg border-0 h-100">
                    <div class="card-body">
                        <h4 class="fw-bold text-primary text-center mb-0">Transaction Fixed History</h4>
                        <hr>
                        <div class="card-body px-4 py-3">

                            <asp:SqlDataSource runat="server" ConnectionString="<%$ ConnectionStrings:Banking_AppConnectionString6 %>" SelectCommand="SELECT * FROM [Transaction_Fixed]"></asp:SqlDataSource>
                            <div style="overflow-x: auto;">
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Transaction_Fixed_ID" DataSourceID="SqlDataSource1" CssClass="table table-striped table-bordered">
                                    <Columns>
