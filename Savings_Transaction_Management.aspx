<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Savings_Transaction_Management.aspx.cs" Inherits="Banking_WEB.Savings_Transaction_Management" %>
        ...
        <div class="row">
                ...
                <div class="card shadow-lg border-0">
                    <div class="card-body px-4 py-5">
                        ...
                        <div class="card-header bg-white border-0 pt-3 text-center">
                            <h3 class="fw-bold" style="color: #2b4d6e;">Transaction Savings</h3>
                            <p class="text-muted small">Manage and review transaction savings details</p>
                        </div>
                        ...
                        <div class="mb-3">
                            <label for="transactionDeposit" class="form-label">Transaction Deposit</label>
                            <asp:TextBox ID="txtTransactionDeposit" runat="server" CssClass="form-control"></asp:TextBox>
                        </div>

                        <div class="mb-3">
                            <label for="transactionForeignAccount" class="form-label">Foreign Account Number</label>
                            <asp:TextBox ID="txtTransactionForeignAccount" runat="server" CssClass="form-control"></asp:TextBox>
                        </div>
            ...
            <div class="col-md-7 mb-4">
                <div class="card shadow-lg border-0 h-100">
                    <div class="card-body">
                        <h4 class="fw-bold text-primary text-center mb-0">Transaction Savings History</h4>
                        <hr>
                        <div class="card-body px-4 py-3">

                            <asp:SqlDataSource runat="server" ConnectionString="<%$ ConnectionStrings:Banking_AppConnectionString6 %>" SelectCommand="SELECT * FROM [Transaction_Savings]"></asp:SqlDataSource>
                            <div style="overflow-x: auto;">
                                <asp:GridView runat="server" AutoGenerateColumns="False" DataKeyNames="Transaction_Savings_ID" DataSourceID="SqlDataSource1" CssClass="table table-striped table-bordered">
                                    <Columns>
                                        <asp:BoundField DataField="Transaction_Savings_ID" HeaderText="Transaction_Savings_ID" InsertVisible="False" ReadOnly="True" SortExpression="Transaction_Savings_ID" />
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Banking_AppConnectionString6 %>" SelectCommand="SELECT * FROM [Transaction_Savings]"></asp:SqlDataSource>
